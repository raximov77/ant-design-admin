  ...
  const [data, setData] = useState([
      {
        ...
        action: <div className='flex items-center gap-10'>
            <MoreOutlined className='rotate-[90deg] scale-[1.5] hover:scale-[1.7] duration-300 cursor-pointer'/>
            <EditOutlined className='scale-[1.5] hover:scale-[1.7] duration-300 cursor-pointer'/>
            <DeleteOutlined className='scale-[1.5] hover:scale-[1.7] duration-300 cursor-pointer'/>
        </div>
      },
  ]);
